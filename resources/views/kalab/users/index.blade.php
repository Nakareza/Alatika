...
>
    ...
    <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
            ...
            <p class="text-sm text-slate-500 mt-1">
                Manajemen akun pengguna sistem laboratorium (Admin, Mahasiswa, Kaprodi)
            </p>
        </div>

        <a href="{{ route('kalab.users.create') }}" class="btn btn-primary">
    ...
    <div class="card p-6">
        <form 
            method="GET"
            action="{{ route('kalab.users.index') }}"
        ...
        >
            ...
            <select 
                ...
                class="inp lg:w-60"
            >
                <option value="">Semua Role (Admin, Mahasiswa, Kaprodi)</option>
        ...
        <div class="relative bg-white rounded-3xl shadow-2xl max-w-md w-full p-8" @click.away="showDeleteModal = false">
            <div class="flex flex-col items-center text-center">
                ...
                <div class="flex items-center gap-3 w-full">
                    ...
                    <form :action="'/kalab/users/' + deleteUserId" method="POST" class="flex-1">
                        @csrf
                        @method('DELETE')
    ...
    <div x-show="showRoleModal" x-cloak class="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/40 backdrop-blur-sm">
        <div class="relative bg-white rounded-3xl shadow-2xl max-w-md w-full p-8" @click.away="showRoleModal = false">
            <div class="flex flex-col items-center">
                ...
                <form :action="'/kalab/users/' + roleUserId + '/role'" method="POST" class="w-full space-y-6">
                    @csrf
                    @method('PATCH')
                    <div class="space-y-4">
                        <div>
