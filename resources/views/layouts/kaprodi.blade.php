...
<head>
    ...
    <title>@yield('title', 'Dashboard') - Alatika KA Prodi</title>
...
<body class="antialiased" x-data="{}">
    ...
    <div id="mainContent"
        ...
        @include('layouts.header', [
            ...
            'subtitle' => 'Portal Kepala Program Studi'
        ])
            ...
            <div class="text-center">
                ...
                <p class="text-xs"
                   style="color:#94a3b8;">
                    ...
                    Sistem Peminjaman Alat Laboratorium Elektronik
                </p>
