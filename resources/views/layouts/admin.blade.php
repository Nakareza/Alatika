...
<head>
    ...
    <title>@yield('title', 'Dashboard') - Alatika Admin</title>
    ...
    <style>
        ...
        .page-transition { animation: fadeIn 0.5s ease-in forwards; }
    </style>
...
<body class="antialiased" x-data="{}">
    ...
    <div id="mainContent"
     class="transition-all duration-300 ease-in-out bg-[#F5F8FF] relative"
    ...
    <script>
        document.addEventListener('alpine:init', () => {
            Alpine.data('sidebarHandler', () => ({
                collapsed: localStorage.getItem('sidebarCollapsedAdmin') === 'true',

                toggle() {
                    this.collapsed = !this.collapsed;
                    localStorage.setItem('sidebarCollapsedAdmin', this.collapsed);
                ...
                updateMainContent() {
                    ...
                    ? 'transition-all duration-300 ease-in-out ml-20 bg-[#F5F8FF] relative'
                    : 'transition-all duration-300 ease-in-out ml-64 bg-[#F5F8FF] relative';
                    }
                },
