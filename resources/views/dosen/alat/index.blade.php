    ...
    <div id="mainContent" class="transition-all duration-300 ease-in-out ml-64">
        ...
        <header class="bg-white border-b border-gray-200 sticky top-0 z-30">
            <div class="px-8 py-4 flex justify-between">
                ...
                <div>
                    <a href="{{ route('dosen.peminjaman.ajukan') }}" class="inline-flex items-center gap-2 px-4 py-2 bg-blue-600 text-white font-medium rounded-lg hover:bg-blue-700 transition">
