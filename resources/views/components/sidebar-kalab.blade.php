{{-- Sidebar KA Lab - Style Mengikuti Sidebar Mahasiswa --}}
<aside 
        ...
        <div class="flex items-center gap-3"
            ...
            <div x-show="!collapsed"
                ...
                <h3 class="text-sm font-semibold truncate"
                    style="font-family:'Plus Jakarta Sans',sans-serif;color:#1E293B;">
                    {{ Auth::user()->name }}
                </h3>
    ...
    <nav class="p-3 space-y-1 overflow-y-auto h-[calc(100vh-220px)]">
        ...
        <a href="{{ route('kalab.dashboard') }}"
           ...
           style="{{ request()->routeIs('kalab.dashboard') ? 'background:#1E2B4A;color:white;box-shadow:0 4px 14px rgba(30,43,74,0.22);' : 'color:#64748b;' }}"
           x-bind:class="collapsed ? 'justify-center' : ''"
           @if(!request()->routeIs('kalab.dashboard'))
        ...
        <a href="{{ route('kalab.persetujuan') }}"
           class="group flex items-center gap-3 px-3.5 py-3 rounded-xl transition-all duration-200"
           style="{{ request()->routeIs('kalab.persetujuan*') ? 'background:#1E2B4A;color:white;box-shadow:0 4px 14px rgba(30,43,74,0.22);' : 'color:#64748b;' }}"
           x-bind:class="collapsed ? 'justify-center' : ''"
           @if(!request()->routeIs('kalab.persetujuan*'))
           onmouseover="this.style.background='#EBF3FD';this.style.color='#185FA5';"
           onmouseout="this.style.background='';this.style.color='#64748b';"
           @endif>
        ...
        <a href="{{ route('kalab.alat') }}"
           class="group flex items-center gap-3 px-3.5 py-3 rounded-xl transition-all duration-200"
           style="{{ request()->routeIs('kalab.alat*') ? 'background:#1E2B4A;color:white;box-shadow:0 4px 14px rgba(30,43,74,0.22);' : 'color:#64748b;' }}"
           x-bind:class="collapsed ? 'justify-center' : ''"
           @if(!request()->routeIs('kalab.alat*'))
           onmouseover="this.style.background='#EBF3FD';this.style.color='#185FA5';"
           onmouseout="this.style.background='';this.style.color='#64748b';"
           @endif>
        ...
        <!-- Kelola User -->
        <a href="{{ route('kalab.users.index') }}"
           class="group flex items-center gap-3 px-3.5 py-3 rounded-xl transition-all duration-200"
           style="{{ request()->routeIs('kalab.users*') ? 'background:#1E2B4A;color:white;box-shadow:0 4px 14px rgba(30,43,74,0.22);' : 'color:#64748b;' }}"
           x-bind:class="collapsed ? 'justify-center' : ''"
           @if(!request()->routeIs('kalab.users*'))
           onmouseover="this.style.background='#EBF3FD';this.style.color='#185FA5';"
           onmouseout="this.style.background='';this.style.color='#64748b';"
           @endif>
        ...
        <a href="{{ route('kalab.riwayat') }}"
           class="group flex items-center gap-3 px-3.5 py-3 rounded-xl transition-all duration-200"
           style="{{ request()->routeIs('kalab.riwayat*') ? 'background:#1E2B4A;color:white;box-shadow:0 4px 14px rgba(30,43,74,0.22);' : 'color:#64748b;' }}"
           x-bind:class="collapsed ? 'justify-center' : ''"
           @if(!request()->routeIs('kalab.riwayat*'))
           onmouseover="this.style.background='#EBF3FD';this.style.color='#185FA5';"
           onmouseout="this.style.background='';this.style.color='#64748b';"
           @endif>
        ...
        <a href="{{ route('kalab.laporan') }}"
           class="group flex items-center gap-3 px-3.5 py-3 rounded-xl transition-all duration-200"
           style="{{ request()->routeIs('kalab.laporan*') ? 'background:#1E2B4A;color:white;box-shadow:0 4px 14px rgba(30,43,74,0.22);' : 'color:#64748b;' }}"
           x-bind:class="collapsed ? 'justify-center' : ''"
           @if(!request()->routeIs('kalab.laporan*'))
           onmouseover="this.style.background='#EBF3FD';this.style.color='#185FA5';"
           onmouseout="this.style.background='';this.style.color='#64748b';"
           @endif>
        ...
        <a href="{{ route('kalab.profil') }}"
           class="group flex items-center gap-3 px-3.5 py-3 rounded-xl transition-all duration-200"
           style="{{ request()->routeIs('kalab.profil') ? 'background:#1E2B4A;color:white;box-shadow:0 4px 14px rgba(30,43,74,0.22);' : 'color:#64748b;' }}"
           x-bind:class="collapsed ? 'justify-center' : ''"
           @if(!request()->routeIs('kalab.profil'))
           onmouseover="this.style.background='#EBF3FD';this.style.color='#185FA5';"
           onmouseout="this.style.background='';this.style.color='#64748b';"
           @endif>
