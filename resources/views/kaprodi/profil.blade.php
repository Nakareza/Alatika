        ...
        <button @click="showLogoutModal = true"
            ...
            <div class="text-left flex-1">
                ...
                <p class="text-sm text-red-500">
                    Keluar dari akun Kepala Program Studi
                </p>
        ...
        <div x-show="showLogoutModal"
            ...
            <div class="flex flex-col items-center text-center">
                ...
                <div class="flex items-center gap-3 w-full">
                    ...
                    <button type="button"
                            @click="document.getElementById('logoutFormKaprodi').submit()"
...
{{-- Hidden Logout Form --}}
<form action="{{ route('logout') }}" method="POST" id="logoutFormKaprodi" style="display: none;">
    @csrf
</form>
